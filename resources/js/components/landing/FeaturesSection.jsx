                ...
                {features.map((feature, i) => (
                    <ScrollReveal key={feature.title} delay={i * 0.08}>
                        ...
                        >
                            ...
                            <div className="relative z-10 mb-6 flex h-14 w-14 items-center justify-center rounded-xl bg-brand-50 text-2xl text-brand-600 shadow-soft transition-transform duration-300 group-hover:scale-110">
                                {feature.icon}
                            </div>
